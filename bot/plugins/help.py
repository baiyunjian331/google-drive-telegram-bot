...
def map(pos):
    if(pos==1):
        ...
        button = [
            [
             InlineKeyboardButton(text = '支持群组', url = SUPPORT_CHAT_LINK),
             InlineKeyboardButton(text = '功能建议', url = "https://github.com/viperadnan-git/google-drive-telegram-bot/issues/new")
            ],
